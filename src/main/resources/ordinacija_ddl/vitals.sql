...
CREATE TABLE `vitals` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `vitals_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

INSERT INTO `vitals`
	(`id`, `measuring_date`, `diastolicbp`, `systolicbp`, `body_temp`, `heart_rate`, `height`, `mass`, `patient_id`)
VALUES
